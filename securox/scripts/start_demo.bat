...
set PYTHONPATH=%CD%\securox\backend\app;%CD%\securox;%PYTHONPATH%
...
IF ERRORLEVEL 1 (
    ...
    pip install -r securox\backend\requirements.txt
)
...
REM Run Uvicorn server from securox/backend/app
